!function() {
    ...
    d3.geo.zoom = function() {
        ...
        m = d3.behavior.zoom().on("zoomstart",
        function() {
            var r = d3.mouse(this),
            i = e(h.rotate()),
            u = n(h, r);
        ...
        m.event = function(t) {
            t.each(function() {
                ...
                if (o !== t) {
                    ...
                    try {
                        o.each("interrupt.zoom",
                        function() {
                            d(n)
                        })
                    } catch(i) {}
                } else this.__chart__ = z,
                s(n),
                l(n),
                d(n)
            })
...
function() {
    function t(t, n, e) {
        ...
        t.append("path").datum({
            type: "Sphere"
        }).attr("class", "foreground").attr("d", n).on("mousedown.grab",
        function() {
            var n;
            ...
            r = d3.select(window).on("mouseup.grab",
            function() {
                o.classed("zooming", !1),
    ...
    r = d3.dispatch("world"),
    c = -1;
    d3.selectAll("#map, #eisenlohr").data([n(a, o).scale(140).translate([a / 2, .5 * o]), d3.geo.eisenlohr().precision(.1).clipExtent([[ - 1, -1], [a + 1, o + 1]]).translate([a / 2, o / 2]).scale(75).rotate([0, -30])]).append("svg").attr("width", a).attr("height", o).each(function(n) {
        var e = d3.geo.path().projection(n),
        a = d3.select(this).call(t, e, !0);
        a.selectAll(".foreground").call(d3.geo.zoom().projection(n).scaleExtent([.8 * n.scale(), 10 * n.scale()]).on("zoom.redraw",
        function() {
    ...
    function() {
        function a(e, a, u) {
            ...
            var m = d3.behavior.drag().on("drag",
            function() {
